...
$appointments = [];
$msg = "";
$available_slots = ['09:00', '10:30', '13:30', '15:00', '17:45', '18:00', '18:15'];

// 0. AUTO-CLEAN: TỰ ĐỘNG ĐÁNH DẤU BÙNG LỊCH (NO-SHOW) QUÁ 1 TIẾNG
try {
    $pdo->exec("UPDATE Appointments SET status = 'No-Show' WHERE status = 'Scheduled' AND CONCAT(appointment_date, ' ', appointment_time) < DATE_SUB(NOW(), INTERVAL 1 HOUR)");
