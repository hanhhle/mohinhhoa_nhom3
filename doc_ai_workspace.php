                    ...
                    <div class="p-8 flex flex-col h-full">
                        ...
                        <div class="grid grid-cols-2 gap-8 mb-8 border-b border-gray-100 pb-8">
                            ...
                            <div class="text-center bg-gray-50 rounded-2xl p-4 border border-gray-100">
                                <div class="w-20 h-20 mx-auto rounded-full <?php echo getAvatarColor($patientInfo['full_name']); ?> text-white flex items-center justify-center text-3xl font-bold shadow-sm mb-3">
                                    <?php echo getInitials($patientInfo['full_name']); ?>
                                </div>
