                                ...
                                <a href="pat_messages.php?receiver_id=<?php echo $msg['sender_id']; ?>" class="flex items-start gap-4 p-5 border-b border-gray-50 last:border-0 hover:bg-blue-50/20 transition-colors group">
                                    <div class="relative flex-shrink-0">
                                        <?php if($msg['role'] == 'Admin'): ?>
                                            <div class="w-12 h-12 rounded-full bg-[#003366] text-white flex items-center justify-center font-bold text-sm shadow-sm">PC</div>
                                        <?php else: ?>
                                            <div class="w-12 h-12 rounded-full <?php echo getAvatarColor($msg['sender_name']); ?> text-white flex items-center justify-center font-bold text-sm shadow-sm">
                                                <?php echo getInitials($msg['sender_name']); ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="bg-white border-2 border-yellow-100 rounded-xl p-6 hover:shadow-lg transition-all relative overflow-hidden group">
                                    ...
                                    <div class="relative z-10 flex flex-col h-full">
                                        <div class="flex items-center gap-4 mb-4">
                                            <div class="w-14 h-14 rounded-full <?php echo getAvatarColor($fee['doctor_name']); ?> text-white flex items-center justify-center text-lg font-bold shadow-sm border-2 border-white">
                                                <?php echo getInitials($fee['doctor_name']); ?>
                                            </div>
                                            <div>
