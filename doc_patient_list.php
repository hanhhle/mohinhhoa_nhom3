                            ...
                            <?php else: ?>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-blue-50/20 transition-colors patient-row">
                                    <td class="py-4">
                                        ...
                                        <div class="w-10 h-10 rounded-full <?php echo getAvatarColor($p['full_name']); ?> text-white flex items-center justify-center font-bold text-sm shadow-sm border border-gray-200">
                                            <?php echo getInitials($p['full_name']); ?>
                                        </div>
