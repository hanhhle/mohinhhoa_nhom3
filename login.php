...
<body class="bg-[#f8fafc]">
    <header class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <i class="fa-solid fa-lungs text-4xl text-red-400"></i>
                <div class="text-3xl font-bold tracking-tight text-gray-700">Pneumo-<span class="text-blue-500">Care</span></div>
            </div>
            <nav class="flex items-center text-[15px] font-medium">
                <a href="register_patient.php" class="text-blue-600 hover:text-blue-800 font-bold text-base transition-colors">Create an Account</a>
            </nav>
        </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto px-8 py-12 flex gap-16 items-center">
        ...
        <div class="flex-1 hidden lg:flex items-center justify-center">
            <img src="image.png" alt="Medical Illustration" class="max-w-[520px] w-full mix-blend-multiply opacity-90 drop-shadow-lg">
        </div>
    </main>
