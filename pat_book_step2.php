<?php
// ==========================================
// TÊN FILE: pat_book_step2.php
// CHỨC NĂNG: Chọn Bác sĩ và Lịch khám
// ==========================================
session_start();
require 'db.php';
...
$afternoon_slots = ['13:30', '15:00', '17:45', '18:00', '18:15'];
?>
        ...
        <div class="content-area max-w-5xl mx-auto w-full">
            ...
            <div class="space-y-4 mb-10">
                <?php foreach($doctors as $doc): ?>
                    <div class="bg-white border <?php echo ($expanded_doc == $doc['user_id']) ? 'border-blue-500 ring-1 ring-blue-500 shadow-md' : 'border-gray-100 hover:shadow-sm'; ?> rounded-xl p-5 transition-all">
                        
                        <div class="flex items-center gap-5">
                            <div class="w-16 h-16 rounded-full <?php echo getAvatarColor($doc['full_name']); ?> text-white flex items-center justify-center text-xl font-bold shadow-sm flex-shrink-0">
                            ...
                            <?php if($expanded_doc == $doc['user_id']): ?>
                                <button class="bg-gray-100 text-gray-600 hover:bg-gray-200 px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors flex-shrink-0" onclick="location.href='pat_book_step2.php'">Cancel</button>
                            <?php else: ?>
                                <button class="bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-600 hover:text-white px-8 py-2.5 rounded-lg text-sm font-semibold transition-colors flex-shrink-0" onclick="location.href='?expand_doc=<?php echo $doc['user_id']; ?>'">Pick Doctor</button>
                            <?php endif; ?>
                        </div>
