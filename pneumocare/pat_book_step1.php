  ...
  <div class="main-content">
    ...
    <div class="appt-card">
      <form method="POST" action="">
          <div class="appt-grid">
            <div class="form-group"><label>Name *</label><input class="form-input" name="name" value="<?php echo htmlspecialchars($userInfo['full_name'] ?? ''); ?>" required></div>
            <div class="form-group"><label>Date of Birth (DOB) *</label><input type="date" class="form-input" name="dob" value="<?php echo htmlspecialchars($userInfo['date_of_birth'] ?? ''); ?>" required></div>
            <div class="form-group"><label>Phone Number *</label><input class="form-input" name="phone" value="<?php echo htmlspecialchars($userInfo['phone_number'] ?? ''); ?>" required></div>
            <div class="form-group"><label>Gender *</label><select class="form-select" name="gender"><option value="Male" <?php echo ($userInfo['gender'] ?? '') == 'Male' ? 'selected' : ''; ?>>Male</option><option value="Female" <?php echo ($userInfo['gender'] ?? '') == 'Female' ? 'selected' : ''; ?>>Female</option></select></div>
            <div class="form-group"><label>Email Address *</label><input type="email" class="form-input" name="email" value="<?php echo htmlspecialchars($userInfo['email'] ?? ''); ?>" required></div>
            <div class="form-group"><label>Current Residence *</label><input class="form-input" name="address" required></div>
            <div class="form-group"><label>ID/Passport *</label><input class="form-input" name="id_card" required></div>
          </div>
