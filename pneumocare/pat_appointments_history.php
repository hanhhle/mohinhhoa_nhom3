  ...
  <div class="main-content">
    ...
    <div class="table-card">
      ...
      <table class="data-table">
        <thead><tr><th>Time</th><th>Date</th><th>Doctor</th><th>Fee Status</th><th>Action</th></tr></thead>
        <tbody>
          <?php if(empty($completed)): ?>
              <tr><td colspan="5" style="text-align:center; padding:20px; color:#9ca3af;">No completed appointments yet.</td></tr>
          <?php else: ?>
              ...
              <tr>
                ...
                <td><?php echo $row['fee_status'] == 'Paid' ? '<span class="link-green">Paid</span>' : '<span style="color:#ef4444; font-weight:600;">Unpaid</span>'; ?></td>
                <td><?php if($row['fee_status'] == 'Unpaid') echo '<a href="pat_payment.php?id='.$row['appointment_id'].'" style="color:#3b82f6; font-weight:600; text-decoration:none;">Pay Now</a>'; ?></td>
              </tr>
              <?php endforeach; ?>
          <?php endif; ?>
        </tbody>
