                        ...
                        <tbody id="appointmentTable">
                            ...
                            <?php foreach($appointments as $appt): ?>
                                <tr class="row-new border-b border-gray-50 hover:bg-blue-50/20 transition-colors" data-date="<?php echo $appt['appointment_date']; ?>">
                                    ...
                                    <td class="py-5">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-full <?php echo getAvatarColor($appt['patient_name']); ?> text-white flex items-center justify-center font-bold text-sm shadow-sm border border-gray-200 flex-shrink-0">
                                ...
                                <tr class="row-completed hide border-b border-gray-50 hover:bg-gray-50 transition-colors" data-date="<?php echo $row['appointment_date']; ?>">
                                    ...
                                    <td class="py-5">
                                        <div class="flex items-center gap-3 opacity-80">
                                            <div class="w-8 h-8 rounded-full <?php echo getAvatarColor($row['patient_name']); ?> text-white flex items-center justify-center text-xs font-bold shadow-sm flex-shrink-0">
